...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  __INIT_VAR(data__->EMSTOP,__BOOL_LITERAL(FALSE),retain)
  ...
  __INIT_VAR(data__->_TMP_AND50_OUT,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->_TMP_NOT44_OUT,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->_TMP_OR46_OUT,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->_TMP_AND51_OUT,__BOOL_LITERAL(FALSE),retain)
}
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->,_TMP_AND50_OUT,,AND__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)(!(__GET_VAR(data__->E2,)) && !(__GET_VAR(data__->E1,))),
    (BOOL)!(__GET_VAR(data__->EMSTOP,))));
  __SET_VAR(data__->,P2,,__GET_VAR(data__->_TMP_AND50_OUT,));
  __SET_VAR(data__->,_TMP_NOT44_OUT,,!(!(__GET_VAR(data__->E1,))));
  __SET_VAR(data__->,_TMP_OR46_OUT,,OR__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)(!(__GET_VAR(data__->E2,)) && !(__GET_VAR(data__->E1,))),
    (BOOL)(!(__GET_VAR(data__->E2,)) && __GET_VAR(data__->_TMP_NOT44_OUT,))));
  __SET_VAR(data__->,_TMP_AND51_OUT,,AND__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)!(__GET_VAR(data__->EMSTOP,)),
    (BOOL)__GET_VAR(data__->_TMP_OR46_OUT,)));
  __SET_VAR(data__->,P1,,__GET_VAR(data__->_TMP_AND51_OUT,));
